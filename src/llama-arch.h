...
enum llm_kv {
    ...
    // DSpark: nested under "<arch>.dspark.*" instead of the flat "<arch>.*" DFlash uses
    ...
    LLM_KV_DSPARK_CONFIDENCE_HEAD_WITH_MARKOV,
...
enum llm_tensor {
    ...
    // DSpark: tensor names carry a "dspark." prefix (unlike DFlash's bare "fc"/"enc.output_norm")
    LLM_TENSOR_DSPARK_FC,
    LLM_TENSOR_DSPARK_HIDDEN_NORM,
    LLM_TENSOR_DSPARK_LOG_SNR_FC1,
    LLM_TENSOR_DSPARK_LOG_SNR_FC2,
    LLM_TENSOR_DSPARK_MARKOV_A,
    LLM_TENSOR_DSPARK_MARKOV_B,
    LLM_TENSOR_DSPARK_CONFIDENCE,
};
