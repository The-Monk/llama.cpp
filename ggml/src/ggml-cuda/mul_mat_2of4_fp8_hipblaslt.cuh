// mul_mat_2of4_fp8_hipblaslt.cuh - 2OF4_FP8 hipBLASLt prefill GEMM route header
//
// Route 2OF4_FP8 (8.5 bpw: 32-elem block, symmetric int8 x per-block d scale, no min.
...
// In-scope check for the hipBLASLt prefill path (2OF4_FP8 weight, F32 acts/dst, 2D,
...
// Run the 2OF4_FP8 prefill matmul through hipBLASLt int8/fp8. Returns false if the
