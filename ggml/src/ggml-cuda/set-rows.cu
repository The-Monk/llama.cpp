...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    } else if (dst->type == GGML_TYPE_F8E4M3) {
        // T80: F8E4M3 KV-cache write path (per-token K/V insert).
        set_rows_cuda_quant<idx_t, block_f8e4m3, QK_F8E4M3, quantize_f32_f8e4m3_block>(
            src0_d, src1_d, (block_f8e4m3*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
