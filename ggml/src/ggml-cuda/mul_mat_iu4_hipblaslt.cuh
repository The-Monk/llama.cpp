// mul_mat_iu4_hipblaslt.cuh - IU4 hipBLASLt prefill GEMM route header
//
// Route IU4 (8.5 bpw: 32-elem block, symmetric int8 x per-block d scale, no min.
...
// In-scope check for the hipBLASLt prefill path (IU4 weight, F32 acts/dst, 2D,
...
// Run the IU4 prefill matmul through hipBLASLt int8/fp8. Returns false if the
