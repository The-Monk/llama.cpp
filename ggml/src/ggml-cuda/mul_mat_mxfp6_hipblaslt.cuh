// mul_mat_mxfp6_hipblaslt.cuh - MXFP6 hipBLASLt prefill GEMM route header
//
// Route MXFP6 (8.25 bpw OCP MX: e3m2 6-bit elems (4 per 3 bytes) + per-32-block UE8M0 scale.
...
// In-scope check for the hipBLASLt prefill path (MXFP6 weight, F32 acts/dst, 2D,
...
// Run the MXFP6 prefill matmul through hipBLASLt int8/fp8. Returns false if the
