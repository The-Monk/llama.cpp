// mul_mat_f8e4m3_hipblaslt.cuh - F8E4M3 hipBLASLt prefill GEMM route header
//
// Route F8E4M3 (8.5 bpw: 32-elem block, symmetric int8 x per-block d scale, no min.
...
// In-scope check for the hipBLASLt prefill path (F8E4M3 weight, F32 acts/dst, 2D,
...
// Run the F8E4M3 prefill matmul through hipBLASLt int8/fp8. Returns false if the
