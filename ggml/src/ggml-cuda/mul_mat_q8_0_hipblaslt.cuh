// mul_mat_q8_0_hipblaslt.cuh - Q8_0 hipBLASLt prefill GEMM route header
//
// Route Q8_0 (8.5 bpw: 32-elem block, symmetric int8 x per-block d scale, no min.
...
// In-scope check for the hipBLASLt prefill path (Q8_0 weight, F32 acts/dst, 2D,
...
// Run the Q8_0 prefill matmul through hipBLASLt int8/fp8. Returns false if the
