// mul_mat_f8e5m2_hipblaslt.cuh - F8E5M2 hipBLASLt prefill GEMM route header
//
// Route F8E5M2 (8.5 bpw: 32-elem block, symmetric int8 x per-block d scale, no min.
...
// In-scope check for the hipBLASLt prefill path (F8E5M2 weight, F32 acts/dst, 2D,
...
// Run the F8E5M2 prefill matmul through hipBLASLt int8/fp8. Returns false if the
